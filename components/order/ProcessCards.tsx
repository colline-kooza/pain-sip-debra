...
export default function ProcessCards({orders}:any) {
  return (
    ...
    <Link href="/dashboard/manage-table"  className="flex items-center justify-between bg-[#818cf8] rounded-md shadow-sm p-4 dark:text-black">
    ...
    <Link href="/dashboard/manage-table"  className="flex items-center justify-between bg-[#a5f3fc] rounded-md shadow-sm p-4 dark:text-black">
      <div className="flex items-center space-x-4">
        <div className="space-y-1">
          <p className="text-sm font-medium">Order #F0027</p>
          <h3 className="font-bold text-sm">Item: 8x</h3>
    ...
    <Link href="/dashboard/manage-table" className="flex items-center justify-between bg-[#d946ef] rounded-md shadow-sm p-4 dark:text-black">
      <div className="flex items-center space-x-4 ">
        <div className="space-y-1">
          <p className="text-sm font-medium ">Order #F0027</p>
          <h3 className="font-bold text-sm">Item: 8x</h3>
